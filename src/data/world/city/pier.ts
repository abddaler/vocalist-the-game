...
export const PIER: DistrictDef = {
  ...
  decor: [
    ...
    decor('lamp', 24.5, 2.5),
    decor('lamp', 38.5, 2.5),
    decor('car', 16.5, 4.5, 1),
    decor('car', 35.5, 4.5, 0),

    // Парапет над набережной: всё вдоль перил, проход свободен.
    decor('bollard', 3.5, 7.5),
    decor('bollard', 21.5, 7.5),
    decor('bollard', 25.5, 7.5),
    decor('bin', 18.5, 6.5),
    decor('bench', 14.5, 6.5),
    decor('bike', 34.5, 6.5),

    // Настил: скамьи, пальмы, кафе.
    decor('bench', 16.5, 9.5),
    decor('bench', 36.5, 9.5),
    decor('bin', 31.5, 9.5),
    decor('palm', 4.5, 9.5, 1),
    decor('palm', 20.5, 9.5, 2),
    decor('palm', 39.5, 9.5, 0),
    decor('dog', 23.5, 10.5, 1),
    decor('newsbox', 27.5, 9.5),
    decor('parasol', 10.5, 9.5),

    // Пляж: полотенца, лежаки, зонты, спасательная вышка.
    decor('lifeguard', 32.5, 12.5),
    decor('deckchair', 3.5, 11.5, 0),
    decor('deckchair', 5.5, 13.5, 1),
    decor('umbrella', 4.5, 12.5, 0),
    decor('towel', 8.5, 13.5, 0),
    decor('deckchair', 10.5, 13.5, 2),
    decor('umbrella', 9.5, 11.5, 1),
    decor('towel', 15.5, 12.5, 1),
    decor('boat', 18.5, 14.2, 0),
    decor('surfboard', 24.5, 11.5, 1),
    decor('towel', 26.5, 13.5, 2),
    decor('umbrella', 28.5, 12.5, 1),
    decor('deckchair', 30.5, 13.5, 0),
    decor('deckchair', 35.5, 13.5, 1),
    decor('umbrella', 36.5, 11.5, 0),
    decor('towel', 40.5, 13.5, 3),
    decor('crate', 42.5, 11.5, 1),
    decor('gull', 14, -1, 0),
    decor('gull', 24, -2, 1),
    decor('gull', 32, 0, 0),
  ],

  gates: [gateLeft('boulevard', 4)],
  points: [],
};
