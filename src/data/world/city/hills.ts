...
export const HILLS: DistrictDef = {
  ...
  decor: [
    // Палисадник вдоль террасы. Высокое растёт в разрывах между домами:
    // напротив фасада оно срезало бы вывеску.
    decor('palm', 0.3, 2.5, 2),
    decor('tree', 7.5, 2.5, 0),
    decor('palm', 13.5, 2.5, 1),
    decor('tree', 19.5, 2.5, 1),
    decor('palm', 24.5, 2.5, 2),
    decor('tree', 30.5, 2.5, 2),
    ...
    // Кромка террасы: фонари по тем же швам, мебель у самых перил.
    decor('lamp', 7.5, 3.5),
    decor('lamp', 13.5, 3.5),
    decor('lamp', 18.5, 3.5),
    decor('lamp', 24.5, 3.5),
