...
const ACT_POSE = {
  ...
  // Севший голос: сутулость, рука у горла, голова опущена. Состояние
  // связок игрок должен видеть на человеке, а не только на полоске в
  // углу — полоску в углу не замечают, пока не станет поздно.
  wornA: posed([DOWN[0], p(26.8, 29)], [p(10.6, 40.5), p(20.4, 19.8)], {
    // Голова уходит в плечи, корпус короче: сутулость набирается тем,
    // что плечи опущены к бёдрам, а не поворотом, которого тут нет.
    head: p(18, 13.6),
    neck: p(18, 20.4),
    shoulder: [p(12.9, 25.4), p(23.1, 25.4)],
  }),
  wornB: posed([DOWN[0], p(26.6, 29.4)], [p(10.8, 40.2), p(20.6, 20.4)], {
    head: p(18, 14),
    neck: p(18, 20.8),
    shoulder: [p(13.1, 25.8), p(22.9, 25.8)],
    lift: 1,
  }),
