 ...
 *
 * Плитка на экране — это восемнадцать пикселей по диагонали, поэтому
 * при 2.6 человек шёл сорок шесть пикселей в секунду и пересекал кадр за
 * десять секунд. Улица от этого казалась не большой, а вязкой: ходьба
 * ничего не стоит в симуляции и не должна стоить терпения.
 */
export const WALK_TILES = 4.4;
