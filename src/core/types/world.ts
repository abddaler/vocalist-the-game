...
export interface DecorDef {
  ...
  /**
   * Вдоль какой оси мира развёрнут предмет. Окно, афиша и экран лежат в
   * плоскости своей стены, велосипед стоит вдоль своей дороги: поперёк
   * они читаются наклейкой, а не предметом.
   */
  readonly facing?: 'x' | 'y' | undefined;
}
